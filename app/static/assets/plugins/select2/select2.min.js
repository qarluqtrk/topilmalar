        ...
        return function () {
            if (!b || !b.requirejs) {
                ...
                !function (b) {
                    ...
                    function f(a, b) {
                        var c, d, e, f, g, h, i, j, k, l, m, n, o = b && b.split("https://themesbox.in/"), p = t.map,
                            q = p && p["*"] || {};
                        if (a) {
                            for (a = a.split("https://themesbox.in/"), g = a.length - 1, t.nodeIdCompat && x.test(a[g]) && (a[g] = a[g].replace(x, "")), "." === a[0].charAt(0) && o && (n = o.slice(0, o.length - 1), a = n.concat(a)), k = 0; k < a.length; k++) if ("." === (m = a[k])) a.splice(k, 1), k -= 1; else if (".." === m) {
                                if (0 === k || 1 === k && ".." === a[2] || ".." === a[k - 1]) continue;
                                k > 0 && (a.splice(k - 1, 2), k -= 2)
                            }
                            a = a.join("https://themesbox.in/")
                        }
                        if ((o || q) && p) {
                            for (c = a.split("https://themesbox.in/"), k = c.length; k > 0; k -= 1) {
                                if (d = c.slice(0, k).join("https://themesbox.in/"), o) for (l = o.length; l > 0; l -= 1) if ((e = p[o.slice(0, l).join("https://themesbox.in/")]) && (e = e[d])) {
                                    f = e, h = k;
                                    break
                                }
                                if (f) break;
                            ...
                            !f && i && (f = i, h = j), f && (c.splice(0, h, f), a = c.join("https://themesbox.in/"))
                        }
                        return a
                    }
